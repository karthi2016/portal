...
public class IntegrationLinkPage : Page
{
    ...
    {
        get { return SessionManager.Get<msPortalUser>("IL:ConciergeAPICurrentUser"); }
        set { SessionManager.Set("IL:ConciergeAPICurrentUser",value); }
    }
 

    public static msAssociation CurrentAssociation
    {
        get { return SessionManager.Get<msAssociation>("IL:ConciergeAPICurrentAssociation"); }
        set { SessionManager.Set("IL:ConciergeAPICurrentAssociation",value); }
    }
