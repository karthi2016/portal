...
public static class ConciergeSettings
{
    ...
    public const string DEFAULT_CONFIGURATION_NAMESPACE = "portal";
    ...
    private static Dictionary<string, List<NameValuePair>> CachedConfigurationSettings
    {
        get
        {
            return SessionManager.Get<Dictionary<string, List<NameValuePair>>>("ConciergeSettings:ConfigurationSettings");
        }
        set { SessionManager.Set("ConciergeSettings:ConfigurationSettings", value); }
    }
    ...
    private static string DefaultNamespace
    {
        get
        {
            return string.IsNullOrWhiteSpace(ConfigurationManager.AppSettings["ConciergeConfigurationNamespace"])
                       ? DEFAULT_CONFIGURATION_NAMESPACE
                       : ConfigurationManager.AppSettings["ConciergeConfigurationNamespace"];
        }
    }
