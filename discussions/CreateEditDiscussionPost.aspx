<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateEditDiscussionPost.aspx.cs"
    Inherits="discussions_CreateEditDiscussionPost" MasterPageFile="~/App_Master/GeneralPage.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BreadcrumbBar" runat="Server">
    <a href="<%=string.Format(@"\discussions\ViewDiscussionBoard.aspx?contextID={0}", TargetDiscussionBoard.ID) %>">
        ...
        ></a> <a href="<%=string.Format(@"\discussions\ViewForum.aspx?contextID={0}", targetForum.ID) %>">
            <%= targetForum.Name %>
            ></a> <a href="<%=string.Format(@"\discussions\ViewDiscussionTopic.aspx?contextID={0}", targetDiscussionTopic.ID) %>">
                <%= targetDiscussionTopic.Name%></a>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <div class="section" style="margin-top: 10px">
        <div class="sectionHeaderTitle">
            <h2>
                <asp:Literal ID="lPostReply" runat="server">
            Post Reply</asp:Literal></h2>
        </div>
