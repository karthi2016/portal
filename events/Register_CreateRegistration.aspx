<%@ Page Language="C#" MasterPageFile="~/App_Master/GeneralPage.master" AutoEventWireup="true"
    CodeFile="Register_CreateRegistration.aspx.cs" Inherits="events_Register_CreateRegistration" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="PageContent" runat="Server">
    <asp:Literal ID="PageText" runat="server" />
        <asp:ValidationSummary ID="vsSummary2" ForeColor="Red" Font-Bold="true" DisplayMode="BulletList" ValidationGroup="Custom"
 ...
 <font color=green><B>GROUP REGISTRATION MODE</B></font>
    ...
    <asp:Panel ID="pnlSessions" CssClass="section" Visible="false" runat="server" Style="padding-top: 10px">
        <div class="sectionContent">
            <div class="sectionHeaderTitle">
                <h2>
                    <asp:Literal ID="lSessionsWorkshops" runat="server">Sessions &amp; Workshops</asp:Literal></h2>
            </div>
            <div class="sectionContent">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderStyle-Width="60px">
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="tbQuantity" Width="20px" CssClass="inputText" Visible="false" runat="server"
                                                Text="0" />
                                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="tbQuantity"
                                                ValueToCompare="0" Type="Integer" Operator="GreaterThanEqual" ErrorMessage="Please enter quantities of zero or more"
                                                Display="None" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
    ...
    <asp:Panel ID="pnlGuests" CssClass="section" runat="server" Visible="false" Style="padding-top: 10px">
        <div class="sectionContent">
            <div class="sectionHeaderTitle">
                <h2>
                    <asp:Literal ID="lGuestSpouseReg" runat="server">Guest/Spouse Registration</asp:Literal></h2>
            </div>
            <div class="sectionContent">
                <asp:GridView ID="gvGuests" runat="server" AutoGenerateColumns="false" DataKeyNames="ProductID"
                    GridLines="None" AlternatingRowStyle-CssClass="even" HeaderStyle-CssClass="tableHeaderRow"
                    ShowHeader="false" OnRowDataBound="gvMerchandise_RowDataBound">
                    <Columns>
    ...
    <asp:Panel ID="pnlMerchandise" CssClass="section" runat="server" Visible="false"
        ...
        <div class="sectionContent">
            <div class="sectionHeaderTitle">
                <h2>
                    <asp:Literal ID="lOtherEventItems" runat="server">Other Event-Related Items</asp:Literal></h2>
            </div>
            <div class="sectionContent">
