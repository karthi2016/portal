...
public partial class organizationalLayers_EditOrganizationalLayerInfo : PortalPage
{
    #region Fields
...
#pragma warning restore 0618
    ...
    protected override bool CheckSecurity()
    {
        ...
        return organizationalLayerLeader != null && organizationalLayerLeader.CanUpdateInformation;
    }
    ...
    {
        tbName.Text = targetOrganizationalLayer.Name;
        reDescription.Content = targetOrganizationalLayer.Description;
    ...
    {
        targetOrganizationalLayer.Name = tbName.Text;
        targetOrganizationalLayer.Description = reDescription.Content;

        // custom fields
        cfsOrganizationalLayerFields.Harvest();
