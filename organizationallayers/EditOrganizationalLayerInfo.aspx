<%@ Page Title="" Language="C#" MasterPageFile="~/App_Master/GeneralPage.master"
    AutoEventWireup="true" CodeFile="EditOrganizationalLayerInfo.aspx.cs" Inherits="organizationalLayers_EditOrganizationalLayerInfo" %>
...
<asp:Literal ID="PageText" runat="server" />
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Please enter a name."
    ...
    <div class="section" style="margin-top: 10px" runat="server" id="divPhoneNumbers">
        ...
        <div class="sectionContent">
           <asp:Literal ID="lAtLeastOneContact" runat="server"> Please enter at least one contact number below. Use the <b>Preferred?</b> radio
    ...
    <div class="section" style="margin-top: 10px" runat="server" id="divOtherInformation">
        <div class="sectionContent">
            <uc1:CustomFieldSet ID="cfsOrganizationalLayerFields" runat="server" />
        </div>
    </div>
    <div align="center">
