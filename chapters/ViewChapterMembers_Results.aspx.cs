...
public partial class chapters_ViewChapterMembers_Results : PortalPage
{
    ...
    protected override void InitializeTargetObject()
    {
        ...
        if (targetChapter == null) GoToMissingRecordPage();
    ...
    {
        Search s = MultiStepWizards.ViewChapterMembers.SearchBuilder.Search.Clone();
        ...
        s.AddCriteria(Expr.Equals("Chapter", ContextID));
        s.UniqueResult = true;
